...
public class StudentServiceTest {
	...
	@Test
	void generateStudents_shouldGenerateCorrectNumberOfStudents() {
		...
		for (int i = 0; i < generatedStudents.size(); i++) {
			...
			assertTrue(possibleFirstNames.contains(student.getFirstName()),
					"Generated student first name is not in the expected list");
			assertTrue(possibleLastNames.contains(student.getLastName()),
					"Generated student last name is not in the expected list");
		}
	}
}
